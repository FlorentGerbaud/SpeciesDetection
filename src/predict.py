...
def save_combined_image(
    ...
    Args:
        ...
        combined_results (List[Any]): List of detection results.
...
def combine_results(original_image: np.ndarray, results_list: List[Any]) -> np.ndarray:
    """
    ...
    Args:
        ...
        results_list (List[Any]): List of detection results.
